...
def load_raw_data():
    ...
    print("\norder_items\nShapes:",order_items.shape,"\nData types:\n",order_items.dtypes,order_items.isnull().sum())
    print(order_items.head())

    print("\order_reviews\nShapes:",order_reviews.shape,"\nData types:\n",order_reviews.dtypes,order_reviews.isnull().sum())
    print(order_reviews.head())
    return orders,customers,items,payments,order_items,order_reviews,products;
load_raw_data()